...
collect:: $(COLLECTION_CONFIG_FILES)
	...
	digital-land ${DIGITAL_LAND_OPTS} collect $(ENDPOINT_CSV) --collection-dir $(COLLECTION_DIR) --refill-todays-log $(REFILL_TODAYS_LOGS)

collection::
	digital-land ${DIGITAL_LAND_OPTS} collection-save-csv --collection-dir $(COLLECTION_DIR) --refill-todays-log $(REFILL_TODAYS_LOGS)
