...
ifeq ($(COLLECTION_DATASET_BUCKET_NAME),)
	...
	$(eval LOG_STATUS_CODE := $(shell aws s3 ls s3://$(COLLECTION_DATASET_BUCKET_NAME)/$(REPOSITORY)/collection/log.csv > /dev/null 2>&1 && echo "200" || echo "404"))
	$(eval RESOURCE_STATUS_CODE := $(shell aws s3 ls s3://$(COLLECTION_DATASET_BUCKET_NAME)/$(REPOSITORY)/collection/resource.csv > /dev/null 2>&1 && echo "200" || echo "404"))
